...
NEEDED=()
for pkg in libturbojpeg0 vlc mpv mgba-sdl mednafen pcsxr python3-serial rfkill hcxdumptool hcxtools dnsmasq hostapd sherlock tcpdump mdk4 wifite reaver bully pixiewps tshark; do
